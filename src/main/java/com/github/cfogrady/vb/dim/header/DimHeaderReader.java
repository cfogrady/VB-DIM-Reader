...
public class DimHeaderReader {
    public static DimHeader dimHeaderFromBytes(byte[] bytes) {
        return dimHeaderForBytes(bytes, DimHeader.builder()).build();
    }

    static DimHeader.DimHeaderBuilder dimHeaderForBytes(byte[] bytes, DimHeader.DimHeaderBuilder builder) {
