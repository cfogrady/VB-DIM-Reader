...
public class DimReader {
    ...
    public CardContent readDimCardData(InputStream inputStream, boolean verifyChecksum) {
    ...
    private DimContent readDimData(InputStreamWithNot inputStreamWithNot, byte[] headerBytes, boolean verifyChecksum) throws IOException {
